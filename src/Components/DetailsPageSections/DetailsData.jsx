    ...
    <div className="relative">
      ...
      >
        <img
          src={cardImage}
          alt={name}
          className="rounded-none lg:rounded-b-4xl w-full h-auto"
        />
      </motion.div>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-between gap-4 sm:gap-6">
          <motion.h1
            ...
            className="montserrat text-[#424874] font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-center sm:text-left"
          >
            {name}
          </motion.h1>
          <div className="flex items-center gap-3">
            <motion.a
              href={githubRepo_client}
              target="_blank"
            ...
            >
              <button className="flex items-center gap-1 bg-[#424874] py-2 px-3 montserrat text-xs sm:text-sm font-bold text-[#F4EEFF] cursor-pointer">
                <span>View GitHub Client</span>
                <MdOutlineArrowOutward />
              </button>
            </motion.a>
            <motion.a
              href={githubRepo_server}
              target="_blank"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              <button className="flex items-center gap-1 bg-[#424874] py-2 px-3 montserrat text-xs sm:text-sm font-bold text-[#F4EEFF] cursor-pointer">
                <span>View GitHub Server</span>
                <MdOutlineArrowOutward />
              </button>
            </motion.a>
            <motion.a
        ...
        <motion.h3
          variants={childVariants}
          className="montserrat text-lg sm:text-xl mt-4 sm:mt-5"
        >
        ...
        <motion.div variants={childVariants} className="my-4 sm:my-5">
          <h3 className="montserrat text-xl sm:text-2xl font-semibold">
            About Project:
          </h3>
